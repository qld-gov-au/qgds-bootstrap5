 ...
 * @returns {Promise<T>} A promise that resolves to the value returned by the callback
...
export function isElementVisible(element) {
  ...
  // Check for Bootstrap's d-none class first (common in testing environments)
