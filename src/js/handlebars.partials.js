...
import cdnbeta from "../components/bs5/head/cdn-beta.hbs?raw";
import cdndev from "../components/bs5/head/cdn-dev.hbs?raw";
import cdnprod from "../components/bs5/head/cdn-prod.hbs?raw";
import cdnstaging from "../components/bs5/head/cdn-staging.hbs?raw";
import cdntest from "../components/bs5/head/cdn-test.hbs?raw";
...
export default function handlebarsPartials(handlebars) {
  ...
  handlebars.registerPartial("cdn-beta", cdnbeta);
  handlebars.registerPartial("cdn-dev", cdndev);
  handlebars.registerPartial("cdn-prod", cdnprod);
  handlebars.registerPartial("cdn-staging", cdnstaging);
  handlebars.registerPartial("cdn-test", cdntest);
