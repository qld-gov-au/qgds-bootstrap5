import { Markdown, Canvas, Story } from "@storybook/blocks";
import IconSizes from "./_IconsSizes.mdx";
import { InlineWithText, FlexContainer } from "./icons.stories.js";
...
```html
<span class="qld-icon qld-icon-alert-cancel" aria-hidden="true"></span>
```
{/* prettier-ignore-end */}
